...
class PROJECTKELPIE_API UCharacterAttributeSet : public UAttributeSet
{
	GENERATED_UCLASS_BODY()

	/**
	 *	NOTE ON MUTABLE:
	 *	This is only done so that AttributeSet can be initialized directly in GameplayEffectsTest.cpp without doing a const_cast in 100+ places.
